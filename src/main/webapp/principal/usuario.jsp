          												 ...
          												 <form class="form-material" enctype="multipart/form-data" action="<%= request.getContextPath() %>/ServletUsuarioController" method="post" id="formUser" >
                                                            ...
                                                            <div class="form-group form-default form-static-label">
                                                             ...
                                                             <div class="form-group form-default input-group mb-4">
                                                                  <div class="input-group-prepend">
                                                                    ...
                                                                    <c:if test="${modelLogin.fotouser == '' || modelLogin.fotouser == null}">
                                                                       <img alt="Imagem User" id="fotoembase64"  src="assets/images/duke.jpeg" width="70px">
                                                        			</c:if>
															...
															<select class="form-control" aria-label="Default select example" name="perfil" >
																...
																<option value="AUXILIAR"
																	...
																	if (modelLogin != null && modelLogin.getPerfil()
																			.equals("AUXILIAR")) {
																		out.print(" ");
																		out.print("selected=\"selected\"");
																		out.print(" ");
...
$("#numero").keypress(function(event){  /* Faz com que este campo da tela aceite somente números */
	return /\d/.test(String.fromCharCode(event.keyCode));    	
});


$("#cep").keypress(function(event){  /* Faz com que este campo da tela aceite somente números */
	return /\d/.test(String.fromCharCode(event.keyCode));    	
});
