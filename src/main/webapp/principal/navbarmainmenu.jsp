...
<nav class="pcoded-navbar">
	...
	<div class="pcoded-inner-navbar main-menu">
		<div class="">
			<div class="main-menu-header">
			 ...
			 <c:if test="${imagemUser != '' && imagemUser != null}">
			  ...
			  <c:if test="${imagemUser == '' || imagemUser == null}">
				 <img class="img-80 img-radius" src="<%=request.getContextPath() %>/assets/images/iconeJava.png" alt="Ícone-Java">
			 </c:if>	
			...
			<div class="main-menu-content">
				<ul>
					...
					<!--  <i class="ti-settings"></i>Settings</a> --> <a href="<%=request.getContextPath() %>/ServletLogin?acao=logout">
					  <i class="ti-layout-sidebar-left">  </i>Logout</a></li>
				</ul>
			</div>
		</div>
		<!-- 
		...
		<ul class="pcoded-item pcoded-left-item"><li class="active">
					...
					<c:if test="${perfil == 'ADMINISTRADOR'}">
					  <li class=" ">
						<a href="<%=request.getContextPath()%>/ServletUsuarioController?acao=listarUser" class="waves-effect waves-dark"> 
						 <span class="pcoded-micon"><i class="ti-angle-right"></i></span> <span class="pcoded-mtext" data-i18n="nav.basic-components.alert">Usuário</span>
						 <span	class="pcoded-mcaret"></span>
						</a>
					 </li>
					</c:if>
		...
		<ul class="pcoded-item pcoded-left-item">
			...
			<li>
			     <a
					   href="<%=request.getContextPath()%>/principal/reluser.jsp" class="waves-effect waves-dark"> 
			...
			<li>
				    <a
					   href="<%=request.getContextPath()%>/principal/relusergrafico.jsp" class="waves-effect waves-dark"> 
					   <span class="pcoded-micon"><i class="ti-layers"></i><b>FC</b></span> 
					   <span class="pcoded-mtext" data-i18n="nav.form-components.main">Gráfico de Salário</span>
					   <span mclass="pcoded-mcaret"></span>
				   </a>
			</li>
