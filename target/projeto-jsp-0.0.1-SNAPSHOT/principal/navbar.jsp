		...
		<div class="navbar-container container-fluid">
			...
			<ul class="nav-right">
				...
				<a href="#!" class="waves-effect waves-light"> 
					<img src="https://cdn-icons-png.flaticon.com/512/226/226777.png" alt="Ícone Java Preto" width="32" height="32">
					 <span><%= session.getAttribute("usuario") %></span> <i class="ti-angle-down"></i>
				</a>
					<ul class="show-notification profile-notification">
						...
						<li class="waves-effect waves-light"><a href="<%=request.getContextPath() %>/ServletLogin?acao=logout">
